...
<div style="display:flex;gap:12px;margin-bottom:8px;align-items:stretch;">
  <div style="flex:1;background:#f5f5f5;border-left:4px solid #2d2d2d;border-radius:6px;padding:14px 16px;font-size:0.9rem;color:#1a1a1a;display:flex;align-items:center;">🌍 Most camps are in <b style="margin-left:4px;">northern Azerbaijan</b>&nbsp;(Guba, Ismayilli, Khachmaz)</div>
  <div style="flex:1;background:#f5f5f5;border-left:4px solid #2d2d2d;border-radius:6px;padding:14px 16px;font-size:0.9rem;color:#1a1a1a;display:flex;align-items:center;">☀️ <b style="margin-left:4px;">Summer</b>&nbsp;is the most popular season for camping</div>
  <div style="flex:1;background:#f5f5f5;border-left:4px solid #2d2d2d;border-radius:6px;padding:14px 16px;font-size:0.9rem;color:#1a1a1a;display:flex;align-items:center;">🏔️ Hard-to-reach places average <b style="margin-left:4px;">4.8⭐</b>&nbsp;vs Easy places <b>3.5⭐</b></div>
</div>
""", unsafe_allow_html=True)
