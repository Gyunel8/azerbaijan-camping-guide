...
<svg viewBox="0 0 120 140" xmlns="http://www.w3.org/2000/svg" width="130" height="130">
  <!-- Mountains background -->
  <polygon points="0,110 30,55 60,90 90,40 120,110" fill="#1a3318" opacity="0.6"/>
  <polygon points="0,110 20,70 50,100 80,50 110,85 120,110" fill="#1e3d1a" opacity="0.5"/>
  <!-- Ground -->
  <rect x="0" y="108" width="120" height="32" fill="#1a3318" opacity="0.7"/>
  <!-- Hiker body -->
  <circle cx="72" cy="42" r="7" fill="#e8f0d8"/>
  <!-- Backpack -->
  <rect x="67" y="49" width="12" height="14" rx="3" fill="#c8e0a8"/>
  <rect x="66" y="51" width="3" height="10" rx="1" fill="#c8e0a8"/>
  <!-- Torso -->
  <rect x="69" y="49" width="8" height="15" rx="2" fill="#e8f0d8"/>
  <!-- Left arm (with walking stick) -->
  <line x1="69" y1="54" x2="60" y2="65" stroke="#e8f0d8" stroke-width="2.5" stroke-linecap="round"/>
  <!-- Walking stick -->
  <line x1="60" y1="65" x2="57" y2="80" stroke="#c8e0a8" stroke-width="2" stroke-linecap="round"/>
  <!-- Right arm -->
  <line x1="77" y1="54" x2="83" y2="63" stroke="#e8f0d8" stroke-width="2.5" stroke-linecap="round"/>
  <!-- Left leg -->
  <line x1="72" y1="64" x2="66" y2="78" stroke="#e8f0d8" stroke-width="2.5" stroke-linecap="round"/>
  <line x1="66" y1="78" x2="62" y2="88" stroke="#e8f0d8" stroke-width="2.5" stroke-linecap="round"/>
  <!-- Right leg -->
  <line x1="72" y1="64" x2="78" y2="76" stroke="#e8f0d8" stroke-width="2.5" stroke-linecap="round"/>
  <line x1="78" y1="76" x2="80" y2="88" stroke="#e8f0d8" stroke-width="2.5" stroke-linecap="round"/>
  <!-- Stars -->
  <circle cx="20" cy="20" r="1.2" fill="#e8f0d8" opacity="0.7"/>
  <circle cx="45" cy="12" r="1" fill="#e8f0d8" opacity="0.6"/>
  <circle cx="95" cy="18" r="1.4" fill="#e8f0d8" opacity="0.8"/>
  <circle cx="108" cy="30" r="1" fill="#e8f0d8" opacity="0.5"/>
  <circle cx="10" cy="38" r="1" fill="#e8f0d8" opacity="0.6"/>
</svg>
</div>
""", unsafe_allow_html=True)
    ...
    st.markdown("---")
    st.markdown("### 🏕️ About")
    st.markdown("<small style='color:#c8e0b8'>Created by an aspiring data analyst passionate about travel and outdoor exploration in Azerbaijan.<br><br>All camping spots were personally visited — this is not just a project, it's a travel diary turned into data.<br><br><b>Data Source:</b> Dataset was manually curated using personal travel experience.<br><br>🚀 <b>V2 coming:</b> AI recommendations, weather API, route planning</small>", unsafe_allow_html=True)
