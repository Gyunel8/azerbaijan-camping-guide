...
with st.sidebar:
    ...
    st.markdown("<small style='color:#c8e0b8'>Personal travel diary turned into data — 9 spots visited across Azerbaijan.</small>", unsafe_allow_html=True)
    st.markdown("""
<div style="margin-top:20px;">
<svg viewBox="0 0 300 160" xmlns="http://www.w3.org/2000/svg" width="100%" height="auto">
  <circle cx="20" cy="15" r="1.2" fill="#c8e0a8" opacity="0.7"/>
  <circle cx="55" cy="8" r="1" fill="#c8e0a8" opacity="0.6"/>
  <circle cx="100" cy="18" r="1.4" fill="#c8e0a8" opacity="0.8"/>
  <circle cx="200" cy="12" r="1.2" fill="#c8e0a8" opacity="0.7"/>
  <circle cx="280" cy="8" r="1.3" fill="#c8e0a8" opacity="0.7"/>
  <circle cx="245" cy="35" r="14" fill="none" stroke="#c8e0a8" stroke-width="2"/>
  <line x1="245" y1="15" x2="245" y2="10" stroke="#c8e0a8" stroke-width="1.5" stroke-linecap="round"/>
  <line x1="245" y1="55" x2="245" y2="60" stroke="#c8e0a8" stroke-width="1.5" stroke-linecap="round"/>
  <line x1="225" y1="35" x2="220" y2="35" stroke="#c8e0a8" stroke-width="1.5" stroke-linecap="round"/>
  <line x1="265" y1="35" x2="270" y2="35" stroke="#c8e0a8" stroke-width="1.5" stroke-linecap="round"/>
  <line x1="231" y1="21" x2="227" y2="17" stroke="#c8e0a8" stroke-width="1.5" stroke-linecap="round"/>
  <line x1="259" y1="49" x2="263" y2="53" stroke="#c8e0a8" stroke-width="1.5" stroke-linecap="round"/>
  <line x1="259" y1="21" x2="263" y2="17" stroke="#c8e0a8" stroke-width="1.5" stroke-linecap="round"/>
  <line x1="231" y1="49" x2="227" y2="53" stroke="#c8e0a8" stroke-width="1.5" stroke-linecap="round"/>
  <polygon points="0,160 0,120 40,55 75,95 120,30 165,85 200,60 240,95 270,70 300,90 300,160" fill="#1a3318" opacity="0.7"/>
  <polyline points="0,120 40,55 75,95 120,30 165,85 200,60 240,95 270,70 300,90" fill="none" stroke="#c8e0a8" stroke-width="2" stroke-linejoin="round" opacity="0.9"/>
  <polygon points="18,120 24,105 30,120" fill="#c8e0a8" opacity="0.5"/>
  <polygon points="28,120 33,108 38,120" fill="#c8e0a8" opacity="0.4"/>
  <polygon points="260,115 265,103 270,115" fill="#c8e0a8" opacity="0.5"/>
  <polygon points="272,118 276,108 280,118" fill="#c8e0a8" opacity="0.4"/>
</svg>
</div>
""", unsafe_allow_html=True)
