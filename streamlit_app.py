...
> *All data is based on real personal experience — 9 places visited over multiple years of camping across the country.*""")
    ...
    with col_sur:
        st.markdown('<style>div[data-testid="column"]:nth-child(1) div.stButton > button { background-color: #8b3a2a !important; color: #faeee8 !important; } div[data-testid="column"]:nth-child(1) div.stButton > button:hover { background-color: #7a2a1a !important; }</style>', unsafe_allow_html=True)
