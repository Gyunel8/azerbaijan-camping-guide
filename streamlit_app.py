...
> *All data is based on real personal experience — 9 places visited over multiple years of camping across the country.*""")
    ...
    with col1:
        st.markdown('<div style="background:#f5f5f5;border-left:4px solid #4a5a2a;border-radius:6px;padding:14px 16px;font-size:0.9rem;color:#2d3a18;">🌍 Most camps are in <b>northern Azerbaijan</b> (Guba, Ismayilli, Khachmaz)</div>', unsafe_allow_html=True)
    with col2:
        st.markdown('<div style="background:#f5f5f5;border-left:4px solid #4a5a2a;border-radius:6px;padding:14px 16px;font-size:0.9rem;color:#2d3a18;">☀️ <b>Summer</b> is the most popular season for camping</div>', unsafe_allow_html=True)
    with col3:
        st.markdown('<div style="background:#f5f5f5;border-left:4px solid #4a5a2a;border-radius:6px;padding:14px 16px;font-size:0.9rem;color:#2d3a18;">🏔️ Hard-to-reach places average <b>4.8⭐</b> vs Easy places <b>3.5⭐</b></div>', unsafe_allow_html=True)
